	...
	<body bgcolor="#ffffff">
		...
		<!-- 登録内容の入力 -->
			<table class="float-left" >
				<tr>
					<th>ゲームタイトル</th><td><html:text size="146"  maxlength="50"  name="gameTitle"  property = "gameTitle"  value=""/></td>
				</tr>
				<tr>
					<th>ハードウェア</th><td><html:text size="146"  maxlength="50"  name="hardWare"  property = "hardWare"  value=""/></td>
				</tr>
				<tr>
