...
if(request.getAttribute("error") != null){ 
      ...
      out.print(i );
      out.write("\"  method=\"post\"  action=\"/kenshu/game/delete\"  name=\"deleteForm");
      out.print(i );
      out.write("\" >\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name = \"impression\" value=\"");
      out.print(game.getImpression());
      out.write("\">\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td align=\"right\"><input type=\"hidden\" name = \"id\" value=\"");
      out.print(game.getGameId());
      out.write('"');
      out.write('>');
      out.print(game.getGameId());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"hidden\" name = \"title\" value=\"");
      out.print(game.getGameTitle());
      out.write('"');
      out.write('>');
      out.print(game.getGameTitle());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"hidden\" name = \"hardware\" value=\"");
      out.print(game.getHardWare());
      out.write('"');
      out.write('>');
      out.print(game.getHardWare());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td align=\"right\"><input type=\"hidden\" name = \"character\" value=\"");
      out.print(game.getCharacter_count());
      out.write('"');
      out.write('>');
      out.print(game.getCharacter_count());
      out.write("</td>\r\n");
      ...
      out.write("\t\t\t\t\t<td><input type=\"submit\"  name=\"update\" value=\"修正\"  onclick =\"goUpDate(");
      out.print(i );
      out.write(");\" ></td>\r\n");
